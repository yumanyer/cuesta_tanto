...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==========================================
  const farcasterLoginBtn = document.getElementById('farcasterLogin');

  if (farcasterLoginBtn) {
    farcasterLoginBtn.addEventListener('click', () => {
      console.log('🔵 Click en Login con Farcaster');
      handleFarcasterAuth({
        errorMessage,
        successMessage: null,
